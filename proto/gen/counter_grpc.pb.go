...
const (
	CounterService_GetListOrderFulfillment_FullMethodName = "/go.coffeeshop.proto.counterapi.CounterService/GetListOrderFulfillment"
	CounterService_PlaceOrder_FullMethodName              = "/go.coffeeshop.proto.counterapi.CounterService/PlaceOrder"
)
...
func (c *counterServiceClient) GetListOrderFulfillment(ctx context.Context, in *GetListOrderFulfillmentRequest, opts ...grpc.CallOption) (*GetListOrderFulfillmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, CounterService_GetListOrderFulfillment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *counterServiceClient) PlaceOrder(ctx context.Context, in *PlaceOrderRequest, opts ...grpc.CallOption) (*PlaceOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, CounterService_PlaceOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
